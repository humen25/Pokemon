document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayResult(pkmn) {
    ...
    if (canEvolve) {
      ...
      detailsPara.textContent = `${name} can evolve into ${pkmn.next_evolution} to gain higher stats and abilities.`;
    } else {
      decisionBadge.textContent = "NO / FULLY EVOLVED";
      decisionBadge.className = "badge evolve-no";
      detailsPara.textContent = `${name} has reached its final form or cannot evolve further.`;
    }
